...
let severity : AppLogger.Severity = AppLogger.Severity.info

appLogger.customLog(message: "This is the item that we want to write to both stdout as well as the log file.",
                    severity: severity,
                    operation: operation)
